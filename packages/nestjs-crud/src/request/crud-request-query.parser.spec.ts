...
import { CrudRequestQueryParser } from './crud-request-query.parser';
  ...
  describe('RequestQueryParser', () => {
    ...
    describe('#parseQury', () => {
      it('should return instance of RequestQueryParse', () => {
        expect(qp.parseQuery({})).toBeInstanceOf(CrudRequestQueryParser);
      });
    ...
    describe('#parseParams', () => {
      it('should return instance of RequestQueryParse', () => {
        expect(qp.parseParams({}, {})).toBeInstanceOf(CrudRequestQueryParser);
      });
      it('should throw an error, 1', () => {
